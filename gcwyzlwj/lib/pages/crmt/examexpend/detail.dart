...
class CrmtExamexpendDetail extends StatefulWidget {
  final arguments;
  CrmtExamexpendDetail({Key key, this.arguments}) : super(key: key);

  @override
  _CrmtExamexpendDetailState createState() => _CrmtExamexpendDetailState();
}

class _CrmtExamexpendDetailState extends State<CrmtExamexpendDetail> {
  String checkInfo;
  ...
  submit(status) async {
    ...
    if(data != null){
      ...
      StoreProvider.of<IndexState>(context).dispatch( getExamexpendData(widget.arguments) );
    }
  }
