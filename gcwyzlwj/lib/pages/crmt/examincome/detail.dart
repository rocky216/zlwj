...
class CrmtExamincomeDetail extends StatefulWidget {
  final arguments;
  CrmtExamincomeDetail({Key key, this.arguments}) : super(key: key);

  @override
  _CrmtExamincomeDetailState createState() => _CrmtExamincomeDetailState();
}

class _CrmtExamincomeDetailState extends State<CrmtExamincomeDetail> {
  String checkInfo;
  ...
  String getStatus(int status){
   ...
   submit(status) async {
    ...
    if(data != null){
      ...
      StoreProvider.of<IndexState>(context).dispatch( getExamincomeData(widget.arguments) );
    }
  }
