...
class CrmtIncome extends StatefulWidget {
  final arguments;

  CrmtIncome({Key key, this.arguments}) : super(key: key);

  @override
  _CrmtIncomeState createState() => _CrmtIncomeState();
}

class _CrmtIncomeState extends State<CrmtIncome> {
  String heName;
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StoreConnector<IndexState, Map>(
        ...
        converter: (store)=>store.state.crmt.income, 
            ...
            itemBuilder: (BuildContext context, int index){
              ...
              Container(
                ...
                child: MaterialButton(
                  ...
                  onPressed: (){
                    Navigator.of(context).pushNamed("/crmt/income/detail", arguments: dataList[index-1]);
                  },
                child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(dataList[index-1]["orderTitle"], style: TextStyle(color: Color(0xFF666666)),),
