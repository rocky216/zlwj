...
class CrmtExpend extends StatefulWidget {
  final arguments;

  CrmtExpend({Key key, this.arguments}) : super(key: key);

  @override
  _CrmtExpendState createState() => _CrmtExpendState();
}

class _CrmtExpendState extends State<CrmtExpend> {
  String heName;
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StoreConnector<IndexState, Map>(
        ...
        converter: (store)=>store.state.crmt.expend, 
