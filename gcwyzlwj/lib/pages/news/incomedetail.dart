...
class NewIncomeDetailPage extends StatefulWidget {
  final arguments;
  NewIncomeDetailPage({Key key, this.arguments}) : super(key: key);

  @override
  _NewIncomeDetailPageState createState() => _NewIncomeDetailPageState();
}

class _NewIncomeDetailPageState extends State<NewIncomeDetailPage> {
  String checkInfo;
  Map detail;
  ...
  initial() async {
    var data = await NetHttp.request("/api/app/property/other/newsEnter", context, params: {
              ...
              child: Column(
                children: <Widget>[
                  ...
                  MyCard(
                    ...
                    child: Column(
                      children: (detail["faOtherOrderDescs"] as List).map((f){
